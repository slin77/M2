 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Sizhe");
		  toPrint += p1.toString("slin77");
		  
                  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Shizhe Chen");
		  toPrint += p2.toString("schen381");
		  
                  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Bin Cao");
		  toPrint += p3.toString("bcao9");
                  
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Qi Zhang");
                  toPrint += p4.toString("qzhang300");
                  
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Jing Hong");
                  toPrint += p5.toString("jhong84");
